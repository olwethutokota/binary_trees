...
/**
 * height - This measures height of a binary tree.
...
/**
 * balance - This measures balance factor of binary tree.
...
/**
 * avl_insert_recursive - Inserts value into AVL tree recursively.
