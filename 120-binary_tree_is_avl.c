...
/**
 * height - This will measure the height of a binary tree.
 * @tree: Pointer to root node of tree to measure height.
 *
 * Return: Should tree be NULL, function must return 0, else return height.
 */
size_t height(const binary_tree_t *tree)
{
	if (tree)
...
/**
 * is_avl_helper - This checks if a binary tree is a valid AVL tree.
 * @tree: Pointer to root node of tree to check.
 * @lo: Value of smallest node visited thus far.
 * @hi: Value of largest node visited this far.
 *
 * Return: If tree is valid AVL tree, 1, otherwise, 0.
 */
int is_avl_helper(const binary_tree_t *tree, int lo, int hi)
{
